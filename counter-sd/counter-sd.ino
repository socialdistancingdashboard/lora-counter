...
void setup() {
  ...
  if (SD.exists("counter.txt")) {
    Serial.println("counter exists.");
  } else {
    Serial.println("counter.txt doesn't exist.");
    Serial.println("Creating counter.txt...");
   ...
   if (myFile) {    
    ...
    while (myFile.available()) {
      ...
      counter = myFile.parseInt();
      Serial.println("Uebernehme Counter Wert vor letztem Powercycle:");
